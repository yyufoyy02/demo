...
//     */
//    public static int defaultPopoverBackgroundDrawable = R.drawable.background_purple_popover;
//    /**
//     * The default popover arrow up drawable for all the popovers
//     */
//    public static int defaultPopoverArrowUpDrawable = R.drawable.icon_purple_popover_arrow_up;
//    /**
//     * The default popover arrow down drawable for all the popovers
//     */
//    public static int defaultPopoverArrowDownDrawable = R.drawable.icon_purple_popover_arrow_down;
//    /**
...
//     */
//    private int popoverBackgroundDrawable = PopoverView.defaultPopoverBackgroundDrawable;
//    /**
//     * The popover arrow up drawable
//     */
//    private int popoverArrowUpDrawable = PopoverView.defaultPopoverArrowUpDrawable;
//    /**
//     * The popover arrow down drawable
//     */
//    private int popoverArrowDownDrawable = PopoverView.defaultPopoverArrowDownDrawable;
//    /**
//     * The popover arrow left drawable
//     */
//    private int popoverArrowLeftDrawable = PopoverView.defaultPopoverArrowLeftDrawable;
//    /**
//     * The popover arrow down drawable
//     */
//    private int popoverArrowRightDrawable = PopoverView.defaultPopoverArrowRightDrawable;
//    // ********************************************************************
//    // CONSTRUCTORS
//    // ********************************************************************
//
...
//        // (RelativeLayout.LayoutParams) popoverView
//        // .getLayoutParams();
//        // linearParams.height = 400;
//        // linearParams.width = 560;
//        // linearParams.addRule(RelativeLayout.ALIGN_PARENT_BOTTOM);
//        // popoverView.setLayoutParams(linearParams);
//
...
//        possibleRects = new ArrayMap<Integer, Rect>();
...
//     * 设置粉色气泡
//     */
//    public void setPopoverDrawablePink() {
//
//        setPopoverArrowUpDrawable(R.drawable.icon_popover_arrow_up);
//        setPopoverBackgroundDrawable(R.drawable.background_popover);
//        setPopoverArrowDownDrawable(R.drawable.icon_popover_arrow_down);
//        popoverView.setBackgroundDrawable(getResources().getDrawable(
//                popoverBackgroundDrawable));
//    }
//
...
//     *
//     * @param group           The group we want to insert the popup. Normally a Relative
//     *                        Layout so it can stand on top of everything
//     * @param originRect      The rect we want the popup to appear from (relative to the
//     *                        Application Window!)
//     * @param arrowDirections The mask of bits to tell in which directions we want the
//     *                        popover to be shown
...
//                        popoverView.removeAllViews();
//                        removeAllViews();
//                        if (PopoverView.this.superview != null)
