 ...
 */
public class PullToZoomXListViewEx extends PullToZoomBase<MultiColumnListView> implements PLA_AbsListView.OnScrollListener {
    ...
    public PullToZoomXListViewEx(Context context) {
        this(context, null);
    }

    public PullToZoomXListViewEx(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public void setOnScrollListener(PLA_AbsListView.OnScrollListener l) {
        mRootView.setOnScrollListener(l);
    }

    public void setEmptyView(View emptyView) {
        mRootView.setEmptyView(emptyView);
    }
     ...
     */
    @Override
    protected MultiColumnListView createRootView(Context context, AttributeSet attrs) {
        MultiColumnListView lv = new MultiColumnListView(context, attrs);
        ...
        if (null == adapter || adapter.isEmpty()) {
            if (mRootView.getFirstVisiblePosition() <= 1) {
                ...
                if (firstVisibleChild != null
                    ...
                    XSimpleLogger.Log().e("bb:"+firstVisibleChild.getTop());
                    XSimpleLogger.Log().e("bb:"+mRootView
                            .getTop());
                    return firstVisibleChild.getTop() >= mRootView
                            .getTop();
                }
            }
            return true;
    ...
    public void setHeaderLayoutParams(PLA_AbsListView.LayoutParams layoutParams) {
        if (mHeaderContainer != null) {
        ...
        public void run() {
            if (mZoomView != null) {
                ...
                if ((!mIsFinished) && (mScale > 1.0D)) {
                    ...
                    f2 = mScale - (mScale - 1.0F) * PullToZoomXListViewEx.sInterpolator.getInterpolation(f1);
