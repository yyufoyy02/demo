...
public abstract class PullToRefreshAdapterMultiColumnListViewBase<T extends MultiColumnListView>
	...
	public PullToRefreshAdapterMultiColumnListViewBase(Context context) {
		super(context);
	...
	public void onScrollBaseonScrollBase(final PLA_AbsListView view,
			final int state) {
		/**
