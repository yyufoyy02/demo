...
package com.vk.simpleutil.view.swipebacklayout.lib;
...
public class ViewDragHelper {
     ...
     * callback's
     * {@link com.vk.simpleutil.view.swipebacklayout.lib.ViewDragHelper.Callback#onEdgeTouched(int, int)}
     * and
     * {@link com.vk.simpleutil.view.swipebacklayout.lib.ViewDragHelper.Callback#onEdgeDragStarted(int, int)}
     ...
     * {@link com.vk.simpleutil.view.swipebacklayout.lib.ViewDragHelper.Callback#tryCaptureView(android.view.View, int)}
     ...
     * {@link com.vk.simpleutil.view.swipebacklayout.lib.ViewDragHelper.Callback#getOrderedChildIndex(int)}
     * .
     * 
     * @param x X position to test in the parent's coordinate system
     * @param y Y position to test in the parent's coordinate system
