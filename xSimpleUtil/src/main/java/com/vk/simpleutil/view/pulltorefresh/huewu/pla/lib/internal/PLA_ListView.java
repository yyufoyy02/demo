...
package com.vk.simpleutil.view.pulltorefresh.huewu.pla.lib.internal;
...
import com.vk.simpleutil.view.pulltorefresh.huewu.pla.lib.DebugUtil;
...
public class PLA_ListView extends PLA_AbsListView {
    ...
    public int getLastVisiblePosition() {
        if (mAdapter != null) {
            ...
            return Math.min(mFirstPosition + getChildCount() - 1, -1);
        }
    }
    ...
    public void setSelectionFromTop(int y) {
        mLayoutMode = LAYOUT_SPECIFIC;
        mSpecificTop = y;
        requestLayout();
    }
     ...
     * @param childIndex The index of child (of the View) above the divider. This will
