...
public class PullToRefreshHeadersGridView
        extends
        PullToRefreshAdapterStickyGridHeadersGridViewBase<HeaderGridView>
    ...
    public PullToRefreshHeadersGridView(Context context, Mode mode) {
        super(context, mode);
    }
...
//                    }
    ...
    final class InternalListViewSDK9 extends InternalListView {
        ...
        protected boolean overScrollBy(int deltaX, int deltaY, int scrollX,
            ...
            OverscrollHelper.overScrollBy(
                    PullToRefreshHeadersGridView.this, deltaX,
    ...
    protected class InternalListView extends StickyGridHeadersGridView
        ...
        public void setEmptyView(View emptyView) {
            PullToRefreshHeadersGridView.this.setEmptyView(emptyView);
        }
    ...
    public void setOnXListViewListener(IXListViewListener l) {
        ...
        mListViewListener = l;
        setOnRefreshListener(new OnRefreshListener2<HeaderGridView>() {

            @Override
            public void onPullDownToRefresh(
                    final PullToRefreshBase<HeaderGridView> refreshView) {
                // TODO Auto-generated method stub
                topAction();
            }
            ...
            public void onPullUpToRefresh(
                    final PullToRefreshBase<HeaderGridView> refreshViews) {
                // TODO Auto-generated method stub
                footAction();
            }
        });
