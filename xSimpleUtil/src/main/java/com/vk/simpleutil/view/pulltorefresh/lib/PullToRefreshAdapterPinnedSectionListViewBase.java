...
public abstract class PullToRefreshAdapterPinnedSectionListViewBase<T extends PinnedSectionListView>
	...
	public PullToRefreshAdapterPinnedSectionListViewBase(Context context) {
		super(context);
	...
	public void onScrollBase(final AbsListView view,
	...
	public void onScrollStateChangedBase(final AbsListView view, final int state) {
		/**
	...
	public boolean isLastItemVisible() {
		...
		if (null == adapter || adapter.isEmpty()) {
			...
			if (lastVisibleChild != null
				...
				// MyLogger.ViKingLog().e(
				// mRefreshableView.getFooterViewsCount()
				// + "mRefreshableView.getChildCount():"
