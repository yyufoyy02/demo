...
package com.vk.simpleutil.view.viewpagerheader.delegate;
...
public class PlAListViewDelegate implements ViewDelegate {

    private final int[] mViewLocationResult = new int[2];
    private final Rect mRect = new Rect();

    @SuppressWarnings("ResourceType")
    public boolean isViewBeingDragged(MotionEvent event, PLA_ListView view) {
    ...
    public boolean isReadyForPull(View view, final float x, final float y) {
        ...
        PLA_ListView absListView = (PLA_ListView) view;
