...
package com.vk.simpleutil.view.pulltorefresh.huewu.pla.lib;
...
import com.vk.simpleutil.view.pulltorefresh.huewu.pla.lib.internal.PLA_ListView;
...
public class MultiColumnListView extends PLA_ListView {
	private XListViewItemLongListener mXListViewItemLongListener;
	...
	public void setNum(int i) {
		...
		for (int j = 0; j < mColumnNumber; ++j)
			mColumns[j] = new Column(j);
		mFixedColumn = new FixedColumn();
		invalidate();
	}

	public void setColumnPadding(int mColumnPaddingLeft, int mColumnPaddingRight) {
		this.mColumnPaddingLeft = mColumnPaddingLeft;
		this.mColumnPaddingRight = mColumnPaddingRight;
		invalidate();
	}
	...
	public SparseIntArray getIntItems(){
	return mItems;
}
	// ////////////////////////////////////////////////////////////////////////////
	// Private Methods...
	...
	private class FixedColumn extends Column {
		...
		// /**
		// * 适配器设置 :((XListView) parent).setItemAdapterView(convertView,
		// position)
		// */

	public void setItemAdapterView(View v, int position) {
		v.setOnClickListener(new OnClick(position));
		v.setOnLongClickListener(new OnLongClick(position));
	}
	...
	class OnLongClick implements OnLongClickListener {
		...
		public OnLongClick(int position) {
		...
		public boolean onLongClick(View view) {
			...
			if (mXListViewItemLongListener != null) {
				mXListViewItemLongListener.OnItemLongClick(view, position + 1);
			}
			return true;
		}
	}
	...
	class OnClick implements OnClickListener {
		...
		public void onClick(View view) {
			// TODO Auto-generated method stub
			if (mXListViewItemLongListener != null) {
				mXListViewItemLongListener.OnItemClick(view, position + 1);
			}
		}
	}

	public interface XListViewItemLongListener {
