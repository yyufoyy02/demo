...
import com.vk.simpleutil.view.HeaderGridView;
import com.vk.simpleutil.view.pulltorefresh.internal.EmptyViewMethodAccessor;

public abstract class PullToRefreshAdapterStickyGridHeadersGridViewBase<T extends HeaderGridView>
	...
	public PullToRefreshAdapterStickyGridHeadersGridViewBase(Context context) {
		super(context);
	...
	public PullToRefreshAdapterStickyGridHeadersGridViewBase(Context context, Mode mode) {
		super(context, mode);
		mRefreshableView.setOnScrollListener(this);
	}
