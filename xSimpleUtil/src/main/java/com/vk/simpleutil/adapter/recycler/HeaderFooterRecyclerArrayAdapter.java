package com.vk.simpleutil.adapter.recycler;
...
//        Log.v(TAG, "validateViewType() type=" + viewType);
     ...
     */
    protected ViewHolder onCreateHeaderItemViewHolder(ViewGroup parent, int viewType) {
     ...
     * @return the view holder.
     */
    protected ViewHolder onCreateFooterItemViewHolder(ViewGroup parent, int viewType) {
        throw new UnsupportedOperationException("not implemented");
    }
     ...
     * @param position the position.
     */
    protected void onBindHeaderItemViewHolder(ViewHolder holder, int position) {
        throw new UnsupportedOperationException("not implemented");
    }
     ...
     * @param position the position.
     */
    protected void onBindFooterItemViewHolder(ViewHolder holder, int position) {
        throw new UnsupportedOperationException("not implemented");
    }
