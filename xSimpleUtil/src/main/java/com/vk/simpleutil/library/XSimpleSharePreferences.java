 ...
 */
public class XSimpleSharePreferences {
    private XSimpleSharePreferences() {
    ...
    public static void init(Context mContexts) {
     ...
     * 保存在手机里面的文件名
     */
    public final static String FILE_NAME = "vk_data";
    ...
    public static Object get(String key, Object defaultObject) {
        ...
        return get(mContext, key, defaultObject);
    }
