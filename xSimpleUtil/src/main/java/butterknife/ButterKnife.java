...
import butterknife.annotation.event.EventBase;
import butterknife.info.EventListenerManager;
import butterknife.info.ResLoader;
import butterknife.info.ViewFinder;
import butterknife.info.ViewInjectInfo;
    ...
    private static void injectObject(Object handler, ViewFinder finder) {
        ...
        if (contentView != null) {
            try {
                ...
                XSimpleLogger.Log().e(e.getMessage(), e);
            }
        }
